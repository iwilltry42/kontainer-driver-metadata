...
const CiliumTemplate = `
---
# YAML source: https://raw.githubusercontent.com/cilium/cilium/master/install/kubernetes/quick-install.yaml
...
data:
  ...
  enable-node-port: "{{.RunServiceProxy}}"
